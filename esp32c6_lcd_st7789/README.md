...
- Приложение работает **без RTOS** , но с фреймворком  **embassy** и в **асинхронном режиме** при разделяемом использовании шины `SPI`, к которой подключен дисплей (+ DMA для быстродействия)
